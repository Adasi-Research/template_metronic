...
class StepperComponent {
  ...
  private readonly _goTo = (index: number) => {
  ...
  private readonly _getStepDirection = (index: number) => {
    return index > this.currentStepIndex ? 'next' : 'previous'
  }

  private readonly getStepContent = (index: number) => {
  ...
  private readonly getLastStepIndex = () => {
    return this.totatStepsNumber
  }

  private readonly getTotalStepsNumber = () => {
    return this.totatStepsNumber
  }
  ...
  private readonly isLastStep = () => {
    return this.currentStepIndex === this.totatStepsNumber
  }

  private readonly isFirstStep = () => {
    return this.currentStepIndex === 1
  }

  private readonly isBetweenStep = () => {
  ...
  public goNext = () => {
    this.goto(this.getNextStepIndex())
  }

  public goPrev = () => {
    this.goto(this.getPrevStepIndex())
  }
  ...
  public goLast = () => {
    this.goto(this.getLastStepIndex())
  }
