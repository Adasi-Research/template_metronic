...
class FeedbackComponent {
  ...
  private readonly _go = () => {};

  private readonly showPopup = () => {
  ...
  private readonly setPopupTopCenterPosition = () => {
  ...
  /// ////////////////////
  public show = () => {
    if (!EventHandlerUtil.trigger(this.element, 'kt.feedback.show')) {
      return;
    }
  ...
  public hide = () => {
    if (!EventHandlerUtil.trigger(this.element, 'kt.feedback.hide')) {
      return;
    }
