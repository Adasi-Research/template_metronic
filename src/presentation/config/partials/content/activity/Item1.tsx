      ...
      <div className='timeline-content mb-10 mt-n1'>
        ...
        <div className='overflow-auto pb-5'>
          <div className='d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5'>
            <a href='src/presentation/config/partials/content/activity#' className='fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px'>
            ...
            <a href='src/presentation/config/partials/content/activity#' className='btn btn-sm btn-light btn-active-light-primary'>
              View
            </a>
          </div>
