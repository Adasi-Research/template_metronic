  ...
  return (
    <div className='card'>
      <div className='card-body d-flex flex-center flex-column p-9'>
        ...
        <a href='src/presentation/config/partials/content/cards#' className='fs-4 text-gray-800 text-hover-primary fw-bold mb-0'>
          {name}
        </a>
        ...
        <a href='src/presentation/config/partials/content/cards#' className='btn btn-sm btn-light'>
