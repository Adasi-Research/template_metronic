      ...
      <div className='card-header border-0 pt-5'>
        ...
        <div className='card-toolbar'>
          ...
          >
            ...
            {/* begin::Menu item */}
            <div className='menu-item px-3'>
              <a href='src/presentation/config/partials/widgets/tables#' className='menu-link px-3'>
                New Ticket
              </a>
            </div>
            {/* end::Menu item */}
            ...
            <div className='menu-item px-3'>
              <div className='menu-content px-3 py-3'>
                <a className='btn btn-primary btn-sm px-4' href='src/presentation/config/partials/widgets/tables#'>
                  Generate Reports
                </a>
              </div>
            </div>
          ...
          <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3'>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <a href='src/presentation/config/partials/widgets/tables#' className='text-dark fw-bold text-hover-primary fs-6'>
                    56037-XDER
                  </a>
                </td>
                <td>
                  <a href='src/presentation/config/partials/widgets/tables#' className='text-dark fw-bold text-hover-primary d-block mb-1 fs-6'>
                    Brasil
                  </a>
                ...
                <td className='text-end'>
                  <a
                    href='src/presentation/config/partials/widgets/tables#'
                  ...
                  <a href='src/presentation/config/partials/widgets/tables#' className='btn btn-icon btn-bg-light btn-active-color-primary btn-sm'>
