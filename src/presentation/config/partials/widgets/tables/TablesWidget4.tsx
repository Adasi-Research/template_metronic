          ...
          <ul className='nav'>
            <li className='nav-item'>
              <a
                ...
                data-bs-toggle='tab'
                href='src/presentation/config/partials/widgets/tables#kt_table_widget_4_tab_1'
              >
                Month
              </a>
            </li>
            <li className='nav-item'>
              <a
                ...
                data-bs-toggle='tab'
                href='src/presentation/config/partials/widgets/tables#kt_table_widget_4_tab_2'
              >
                Week
              </a>
            </li>
            <li className='nav-item'>
              <a
                ...
                data-bs-toggle='tab'
                href='src/presentation/config/partials/widgets/tables#kt_table_widget_4_tab_3'
              >
                Day
              </a>
            </li>
              ...
              <table className='table align-middle gs-0 gy-3'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href='src/presentation/config/partials/widgets/tables#' className='text-dark fw-bold text-hover-primary mb-1 fs-6'>
                        Brad Simmons
                      </a>
                    ...
                    <td className='text-end'>
                      <a href='src/presentation/config/partials/widgets/tables#' className='btn btn-icon btn-light-twitter btn-sm me-3'>
                        <i className='bi bi-twitter fs-4'></i>
                      </a>
                      <a href='src/presentation/config/partials/widgets/tables#' className='btn btn-icon btn-light-facebook btn-sm'>
