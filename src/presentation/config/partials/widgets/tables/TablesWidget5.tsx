          ...
          <ul className='nav'>
            <li className='nav-item'>
              <a
                ...
                data-bs-toggle='tab'
                href='src/presentation/config/partials/widgets/tables#kt_table_widget_5_tab_1'
              >
                Month
              </a>
            </li>
            <li className='nav-item'>
              <a
                ...
                data-bs-toggle='tab'
                href='src/presentation/config/partials/widgets/tables#kt_table_widget_5_tab_2'
              >
                Week
              </a>
            </li>
            <li className='nav-item'>
              <a
                ...
                data-bs-toggle='tab'
                href='src/presentation/config/partials/widgets/tables#kt_table_widget_5_tab_3'
              >
                Day
              </a>
            </li>
