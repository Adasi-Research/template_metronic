        ...
        <div className='d-flex align-items-sm-center mb-7'>
          ...
          <div className='d-flex flex-row-fluid align-items-center flex-wrap my-lg-0 me-2'>
            ...
            <div className='flex-grow-1 my-lg-0 my-2 me-2'>
              <a href='src/presentation/config/partials/widgets/lists#' className='text-gray-800 fw-bold text-hover-primary fs-6'>
                Cup &amp; Green
              </a>
            ...
            <div className='d-flex align-items-center'>
              ...
              <a href='src/presentation/config/partials/widgets/lists#' className='btn btn-icon btn-light btn-sm border-0'>
                <KTSVG
