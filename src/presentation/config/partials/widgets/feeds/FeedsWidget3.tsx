      ...
      <div className='card-body pb-0'>
        ...
        <div className='d-flex align-items-center mb-3'>
          ...
          <div className='d-flex align-items-center flex-grow-1'>
            ...
            <div className='d-flex flex-column'>
              <a href='src/presentation/config/partials/widgets/feeds#' className='text-gray-800 text-hover-primary fs-6 fw-bold'>
                Carles Nilson
              </a>
        ...
        <div className='mb-7'>
          ...
          <div className='d-flex align-items-center mb-5'>
            <a
              href='src/presentation/config/partials/widgets/feeds#'
          ...
          <div className='d-flex mb-5'>
            ...
            <div className='d-flex flex-column flex-row-fluid'>
              ...
              <div className='d-flex align-items-center flex-wrap mb-1'>
                <a href='src/presentation/config/partials/widgets/feeds#' className='text-gray-800 text-hover-primary fw-bold me-2'>
                  Alice Danchik
                </a>

                <span className='text-gray-400 fw-semibold fs-7'>1 day</span>

                <a href='src/presentation/config/partials/widgets/feeds#' className='ms-auto text-gray-400 text-hover-primary fw-semibold fs-7'>
                  Reply
                </a>
              </div>
              {/* end::Info */}
