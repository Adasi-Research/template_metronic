        ...
        <div className='card-p mt-n20 position-relative'>
          ...
          <div className='row g-0'>
            ...
            <div className='col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7'>
              ...
              />
              <a href='src/presentation/config/partials/widgets/mixed#' className='text-warning fw-semibold fs-6'>
                Weekly Sales
              </a>
            </div>
            {/* end::Col */}
            ...
            <div className='col bg-light-primary px-6 py-8 rounded-2 mb-7'>
              ...
              />
              <a href='src/presentation/config/partials/widgets/mixed#' className='text-primary fw-semibold fs-6'>
                New Users
              </a>
            </div>
            {/* end::Col */}
          ...
          <div className='row g-0'>
            ...
            <div className='col bg-light-danger px-6 py-8 rounded-2 me-7'>
              ...
              />
              <a href='src/presentation/config/partials/widgets/mixed#' className='text-danger fw-semibold fs-6 mt-2'>
                Item Orders
              </a>
            </div>
            {/* end::Col */}
            ...
            <div className='col bg-light-success px-6 py-8 rounded-2'>
              ...
              />
              <a href='src/presentation/config/partials/widgets/mixed#' className='text-success fw-semibold fs-6 mt-2'>
                Bug Reports
              </a>
            </div>
            {/* end::Col */}
