      ...
      <div className='card-body'>
        ...
        <div className='d-flex flex-stack'>
          ...
          <div className='d-flex align-items-center'>
            ...
            <div className='d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3'>
              <a href='src/presentation/config/partials/widgets/mixed#' className='text-dark fw-bold text-hover-primary fs-5'>
                {title}
              </a>
        ...
        <div className='d-flex flex-column mt-10'>
          ...
          <div className='d-flex'>
            <a
              href='src/presentation/config/partials/widgets/mixed#'
            ...
            <a href='src/presentation/config/partials/widgets/mixed#' className='symbol symbol-35px' data-bs-toggle='tooltip' title='Alice Micto'>
