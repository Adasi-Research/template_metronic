      ...
      <ul className='nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-bold px-9'>
        <li className='nav-item'>
          <a
            ...
            data-bs-toggle='tab'
            href='src/presentation/config/partials/layout/header-menus#kt_topbar_notifications_1'
          >
            Alerts
          </a>
        </li>
        ...
        <li className='nav-item'>
          <a
            ...
            data-bs-toggle='tab'
            href='src/presentation/config/partials/layout/header-menus#kt_topbar_notifications_2'
          >
            Updates
          </a>
        </li>
        ...
        <li className='nav-item'>
          <a
            className='nav-link text-white opacity-75 opacity-state-100 pb-4'
            data-bs-toggle='tab'
            href='src/presentation/config/partials/layout/header-menus#kt_topbar_notifications_3'
          >
            Logs
          </a>
        </li>
