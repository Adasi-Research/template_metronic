  ...
  return (
    ...
    >
      ...
      <div className='text-center'>
        ...
        {/* begin::Google link */}
        <a href='src/presentation/app/modules/auth/components#' className='btn btn-flex flex-center btn-light btn-lg w-100 mb-5'>
          <img
            alt='Logo'
        ...
        {/* begin::Google link */}
        <a href='src/presentation/app/modules/auth/components#' className='btn btn-flex flex-center btn-light btn-lg w-100'>
          <img
            alt='Logo'
