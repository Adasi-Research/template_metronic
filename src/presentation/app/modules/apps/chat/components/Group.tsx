...
import {Dropdown1, ChatInner} from '../../../../../config/partials'
            ...
            >
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  ...
                  <div className='ms-5'>
                    <a href='src/presentation/app/modules/apps/chat/components#' className='fs-5 fw-bold text-gray-900 text-hover-primary mb-2'>
                      Melody Macy
                    </a>
          ...
          <div className='card-header' id='kt_chat_messenger_header'>
            <div className='card-title'>
              <div className='symbol-group symbol-hover'>
                ...
                <a
                  href='src/presentation/app/modules/apps/chat/components#'
