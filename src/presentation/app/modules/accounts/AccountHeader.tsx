...
import {KTSVG, toAbsoluteUrl} from '../../../config/helpers'
import {Link} from 'react-router-dom'
import {Dropdown1} from '../../../config/partials'
            ...
            <div className='d-flex justify-content-between align-items-start flex-wrap mb-2'>
              <div className='d-flex flex-column'>
                <div className='d-flex align-items-center mb-2'>
                  <a href='src/presentation/app/modules/accounts#' className='text-gray-800 text-hover-primary fs-2 fw-bold me-1'>
                    Max Smith
                  </a>
                  <a href='src/presentation/app/modules/accounts#'>
                    <KTSVG
                  ...
                  <a
                    href='src/presentation/app/modules/accounts#'
              ...
              <div className='d-flex my-4'>
                <a href='src/presentation/app/modules/accounts#' className='btn btn-sm btn-light me-2' id='kt_user_follow_button'>
                  <KTSVG
