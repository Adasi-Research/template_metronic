            ...
            <div className='d-flex flex-stack flex-grow-1'>
              <div className='fw-semibold'>
                <div className='fs-6 text-gray-600'>
                  ...
                  <a href='src/presentation/app/modules/accounts/components/settings/cards#' className='fw-bold'>
                    Learn More
                  </a>
                </div>
              </div>
            ...
            <div className='d-flex flex-stack'>
              <div className='d-flex'>
                ...
                <div className='d-flex flex-column'>
                  <a href='src/presentation/app/modules/accounts/components/settings/cards#' className='fs-5 text-dark text-hover-primary fw-bold'>
                    Google
                  </a>
