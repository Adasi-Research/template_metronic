...
import {KTSVG} from '../../../../config/helpers'
import {Card4} from '../../../../config/partials/content/cards/Card4'
    ...
    <>
      <div className='d-flex flex-wrap flex-stack mb-6'>
        ...
        <div className='d-flex my-2'>
          ...
          <a href='src/presentation/app/modules/profile/components#' className='btn btn-primary btn-sm'>
            File Manager
          </a>
        </div>
      </div>
