          ...
          <div className='row mb-8'>
            ...
            <div className='col-lg-9'>
              ...
              <div className='form-text'>
                ...
                <a href='src/presentation/app/modules/profile/components/account#' className='fw-semibold'>
                  Learn more
                </a>
                .
              </div>
          ...
          <div className='row mb-13'>
            ...
            <div className='col-lg-9'>
              ...
              <div className='form-text py-2'>
                ...
                reset your password.
                <a href='src/presentation/app/modules/profile/components/account#' className='fw-boldk'>
                  Learn more
                </a>
                .
              </div>
